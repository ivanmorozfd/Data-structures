...
const char* dequePopFrontMessage = "[ Cистема ] Элемент в конце очереди удален\n\n";
...
const char* avlTreeFindItemMessage01 = "[ Система ] Введите элемент , который нужно найти в АВЛ-дереве\n\n";
const char* avlTreeFindItemMessage02 = "[ Cистема ] Элемент ";
const char* avlTreeFindItemMessage03 = " существует в АВЛ-дереве\n\n";
const char* avlTreeFindItemMessage04 = " не существует в АВЛ-дереве\n\n";
