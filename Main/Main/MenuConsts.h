...
const char* mlistMenuFindFieldBySecondName = "\n[6] Удалить элемент из списка по номеру телефона";
const char* mlistMenuFindFieldByTelephone = "\n[7] Удалить элемент из списка по номеру телефона";
...
const char* mlistPushMessage01 = "[ Система ] Введите пару Фамилия Имя , которую нужно добавить в список\n\n";
